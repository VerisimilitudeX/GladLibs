 ...
 * that can easily
 * model a polygonal shape. Points can be added in order via code or given using
 * a file, one
 * point per line separated by a comma. The points can then be accessed in the
 * order they were
